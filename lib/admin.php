...
add_action('init', 'companies_type_register');
function companies_type_register() {
   $labels = array(
      'name' => 'Companies',
   ...
   register_post_type( 'enclara-companies' , $args );
}



add_action('init', 'execteam_type_register');
function execteam_type_register() {
   $labels = array(
      'name' => 'Executive Team',
      'singular_name' => 'Exec',
      'add_new' => 'New Exec',
      'add_new_item' => 'Add New Exec',
      'edit_item' => 'Edit Exec',
      'new_item' => 'New Exec',
      'view_item' => 'View Execs',
      'search_items' => 'Search Execs',
      'not_found' => 'Found No Executives',
      'not_found_in_trash' => 'Nothing in Trash',
      'parent_item_colon' => ''
   );
   $args = array(
   ...
   register_post_type( 'enclara-execteam' , $args );
}

add_action('init', 'bod_type_register');

function bod_type_register() {
   $labels = array(
      'name' => 'Board of Directors',
      'singular_name' => 'Board Member',
      'add_new' => 'New Board Member',
      'add_new_item' => 'Add New Board Member',
      'edit_item' => 'Edit Board Member',
      'new_item' => 'New Board Member',
      'view_item' => 'View Board Members',
      'search_items' => 'Search Board Members',
      'not_found' => 'Found No Board Members',
      'not_found_in_trash' => 'Nothing in Trash',
      'parent_item_colon' => ''
   );
   $args = array(
   ...
   register_post_type('enclara-bod' , $args);
}
